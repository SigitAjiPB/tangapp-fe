    ...
    return (
        ...
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
            ...
            <div className="max-w-xl lg:max-w-3xl">
                ...
                <textarea
                    id="OrderNotes"
                    className="p-2 mt-2 w-full rounded-lg border-gray-200 align-top shadow-sm sm:text-sm"
                    rows="4"
                ...
                <div className='col-span-2'>
                    ...
                    <div className="flex items-center border-gray-200 bg-white text-sm text-gray-700 shadow-sm mt-1">
                        ...
                        type="number"
                        id="Quantity"
                        className="p-2 w-full border-transparent text-center [-moz-appearance:_textfield] sm:text-sm [&::-webkit-inner-spin-button]:m-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:m-0 [&::-webkit-outer-spin-button]:appearance-none"
                        />
