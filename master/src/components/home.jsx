...
export default function Home () {
  return (
    <div>
      ...
      <div>
        {/* Yui Beban */}
        <div className="bg-sky-400 h-[23rem] -skew-y-6 flex justify-center items-center relative -top-28  sm:-top-32  sm:h-[25rem] md:h-[30rem] lg:h-[40rem] -z-10">
      ...
      {/* End Carding */}
                  ...
                  {/* Footer */} 
                  <footer className="bg-sky-500 text-white mt-36">
                <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                    ...
                    <div>
                        ...
                        <p className="mt-4 max-w-xs text-white">
                            Stop mencatat hutang di kepala, mulailah mencatat masalah finansial bersama Tangapp
                        </p>
                    ...
                    <p className="text-xs text-white">&copy; 2024. Tangapp. All rights reserved.</p>
                </div>
            </footer>
            {/* End Footer */}
    </div>
